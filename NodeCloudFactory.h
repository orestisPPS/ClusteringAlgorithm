...
//     */
//    static NodeCloud<dimensions, numberOfNodes> createNodeCloud(const list<vector<double>> &coordinatesList);
//
//    /**
...
//     */
//    static NodeCloud<dimensions, numberOfNodes> createNodeCloud(const vector<double> &dimensionsLengths, unsigned number23OfNodes, unsigned availableThreads = 1);
//
//
//private:
//
